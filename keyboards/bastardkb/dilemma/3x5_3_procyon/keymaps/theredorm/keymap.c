...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
    ...
    KC_Z,            RALT_T(KC_X),    KC_C,            KC_V,            KC_B,              KC_N,            KC_M,            KC_COMM,         KC_DOT,          KC_SLSH,
                                      MO_NAV,          TAB_TAB,         KC_SPC,            KC_ENT_NUM,      BSP_BSP,         ESC_ESC
  ),
  ...
  [LAYER_NUMERAL] = LAYOUT_split_3x5_3(
    ...
    PT_TILD,         KC_PIPE,         XXXXXXX,         XXXXXXX,         XXXXXXX,           KC_EQUAL,        XXXXXXX,         KC_COMM,         KC_DOT,          PT_SLSH,
  ...
  [LAYER_NAVIGATION] = LAYOUT_split_3x5_3(
    ...
    PT_TILD,         KC_RALT,         XXXXXXX,         XXXXXXX,         DRGSCRL,           MS_WHLD,         KC_HOME,         XXXXXXX,         KC_END,          PT_SLSH,
